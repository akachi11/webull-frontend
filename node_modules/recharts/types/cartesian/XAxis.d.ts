...
export declare const xAxisDefaultProps: {
    ...
    readonly scale: import("recharts/types/util/types").ScaleType | import("recharts/types/util/ChartUtils").RechartsScale | undefined;
    readonly tick: import("recharts/types/util/types").TickProp;
