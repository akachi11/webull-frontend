...
import { AxisDomain, CartesianTickItem, CategoricalDomain, Coordinate, DataKey, LayoutType, NumberDomain, Size, StackOffsetType, TickItem } from 'recharts/types/util/types';
import { AxisId, BaseCartesianAxis, XAxisOrientation, XAxisSettings, YAxisOrientation, YAxisSettings, ZAxisSettings } from 'recharts/types/state/cartesianAxisSlice';
...
import { BaseCartesianGraphicalItemSettings, BasePolarGraphicalItemSettings, CartesianGraphicalItemSettings, GraphicalItemSettings } from 'recharts/types/state/graphicalItemsSlice';
...
import { AllAxisTypes, RenderableAxisType } from 'recharts/types/state/selectors/selectTooltipAxisType';
